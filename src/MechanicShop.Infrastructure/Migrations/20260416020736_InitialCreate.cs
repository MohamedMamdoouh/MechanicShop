        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ServerFingerprint = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    Device_Identifier = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    Device_UserAgent = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
                    Device_IpAddress = table.Column<string>(type: "nvarchar(45)", maxLength: 45, nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAtUtc = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    LastModifiedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LastModifiedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EstimatedRepairDurationMinutes = table.Column<int>(type: "int", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAtUtc = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    LastModifiedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LastModifiedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InvoiceLineItems", x => new { x.LineNumber, x.InvoiceId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RefreshTokens_Device_Identifier",
                table: "RefreshTokens",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkOrders_LaborId_StartAtUtc_EndAtUtc",
                table: "WorkOrders",
                columns: new[] { "LaborId", "StartAtUtc", "EndAtUtc" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkOrders_VehicleId_StartAtUtc_EndAtUtc",
                table: "WorkOrders",
                columns: new[] { "VehicleId", "StartAtUtc", "EndAtUtc" });
        }
